...
from hummingbot.strategy.amm_arbitrage.amm_arbitrage_market_pair import AMMArbitrageMarketPair
...
cdef class AMMArbitrageStrategy(StrategyBase):
    ...
    def __init__(self,
                 market_pairs: List[AMMArbitrageMarketPair],
